...
//                 self.sink.push_token(TokenKind::Designator, digits_from, keep);
//                 if designator_end > keep {
//                     self.sink.push_token(TokenKind::Pad, keep, designator_end);
//                 }
...
//                 if end > name_end + 1 {
//                     self.sink.push_token(TokenKind::Pad, name_end + 1, end);
//                 }
//                 self.mode.awaiting_delimiter_ws = false;
//                 self.mode.pending_payload = Payload::None;
...
//         }
//         if end > index + 1 {
//             self.sink.push_token(TokenKind::Pad, index + 1, end);
//         }
//         end
//     }
...
//                 self.sink.push_token(kind, index, keep);
//                 if run_end > keep {
//                     self.sink.push_token(TokenKind::Pad, keep, run_end);
//                 }
//                 return run_end;
//             }
//         }
